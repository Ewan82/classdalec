...
class DalecData():
    ...
    def __init__(self, lenrun=None, obstr=None, startrun=0, startyr=None, 
        ...
        self.bnds3 = ((1e-8, 1e-2), (0.3, 0.7), (0.01, 0.5), (0.01, 0.5), (1.0001, 10.),
                     (2.5e-5, 1e-3), (1e-4, 1e-2), (1e-4, 1e-2), (1e-7, 1e-3), (0.018, 0.1),
                     (10, 100), (60, 150), (0.001, 0.5), (10, 100), (242, 332), (10, 150), (10, 400),
                     (10, 1000), (1e-8, 1000), (10, 1000), (100, 1e5), (10, 1000), (100, 2e5))
