...
class DalecData():
    ...
    def __init__(self, lenrun=None, obstr=None, startrun=0, startyr=None, 
        ...
        self.mid_bnds = np.array([bnd[0]+(bnd[1]-bnd[0])/2. for bnd in self.bnds_tst])
        self.bnd_vars = np.array([((bnd[1]-bnd[0])/2.)**2. for bnd in self.bnds_tst])
        self.bnd_cov = np.diag(self.bnd_vars)
        ...
        self.sigo_rtot = 0.6
        self.sigo_rh = 0.6
        self.sigo_d_onset = 14.0
        self.sigo_groundresp = 0.5
        ...
        self.errdict = {'clab': self.sigo_clab, 'cf': self.sigo_cf,
                        ...
                        'groundresp': self.sigo_groundresp}
